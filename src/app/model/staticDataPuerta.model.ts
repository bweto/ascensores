...
export class StaticDataPuerta {
    ...
    getElementosMecanicos(): Observable<Pregunta[]> {
        return from([this.elementosMecanicos]);
    }

    getMotorización(): Observable<Pregunta[]> {
        return from([this.motorización]);
    }

    getOtrasComprobaciones(): Observable<Pregunta[]> {
        return from([this.otrasComprobaciones]);
    }

    getInstalacionElectrica(): Observable<Pregunta[]> {
        return from([this.instalacionElectrica]);
    }

    getManiobrasDeSeguridad(): Observable<Pregunta[]> {
        return from([this.maniobrasDeSeguridad]);
    }

    getObservaciones(): Observable<string> {
        return from([this.observaciones]);
    }

    getResultadosInspeccion(): Observable<any> {
        return from([this.resultadosInspeccion]);
    }
